...
namespace SonarAnalyzer.Rules.CSharp
{
    ...
    public sealed class UcfgGeneratorUtility : SonarDiagnosticAnalyzer
    {
        ...
        public UcfgGeneratorUtility()
            : this(new DefaultAnalyzerConfiguration())
        {
        }

        public UcfgGeneratorUtility(IAnalyzerConfiguration configuration)
        {
